...
namespace LanguageAdapter.CSharp.L6_BaseObject
{
    /// <summary>
    /// BaseObject
    /// </summary>
    ...
    public abstract class CBaseObject : IToString, IDispose //C: Class.
    {
        ...
        /// 
        /// </summary>
        protected CBaseObject() //If the constructor is protected, the singleton class can be inherited.
        {
        ...
        {
            return !fDisposedTime.Equals(CDateTimeHelper.getDefault());
        }
        ...
        /// <returns></returns>
        public abstract string[] toStrings(bool iWithFieldNames, DateTimeKind iDateTimeKind = DateTimeKind.Utc, Action<Exception> iExceptionHandler = null);
        //{
        ...
        /// <param name="iExceptionHandler"></param>
        /// <returns></returns>
        public string toString(Action<Exception> iExceptionHandler = null)
        {
